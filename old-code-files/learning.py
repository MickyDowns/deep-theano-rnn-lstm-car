...
# turn model settings
TURN_TOTAL_SENSORS = 10 # front five sonar distance and color readings
...
AVOID_TOTAL_SENSORS = 16 # seven sonar distance + color readings, turn action, current speed
