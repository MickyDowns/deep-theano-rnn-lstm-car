...
import numpy as np
from nn import turn_net, avoid_net, acquire_net, hunt_net
import random
...
TURN_NUM_SENSOR = 10 # front five sonar distance readings
    ...
    while True:
        ...
        if cur_mode == HUNT:
            ...
            if hunt_action == HUNT_AVOID: # accept avoid model action
                ...
                turn_action = acquire_action
                if cur_speed > 0:
                    speed_action = 1 # continue current speed
                else:
...
if __name__ == "__main__":
    turn_model = turn_model_1 = turn_model_2 = turn_model_3 = avoid_model = \
