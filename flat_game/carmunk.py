...
class GameState:
    ...
    def create_car(self, x, y, r):
        ...
        self.car_shape = pymunk.Circle(self.car_body, 25) # was 25
        self.car_shape.color = THECOLORS[DRONE_COLOR]
    ...
    def evaluate_move(self, drone_id, heading_adjust, min_sonar_dist):
        ...
        if cur_mode != PACK:
            ...
            if cur_mode == ACQUIRE:
                ...
                avoid_move_efficiency = ndo / target_dist**0.333 # was 0.333
                acquire_move_efficiency = ndt / target_dist**0.333
        ...
        if target_dist <= TARGET_RADIUS:
            ...
            if len(self.acquired_targets) % 10 == 1:
    ...
    def calc_rwd(self, drone_id, min_sonar_dist, driving_direction, cur_speed, avoid_move_efficiency, acquire_move_efficiency):
        ...
        if min_sonar_dist <= 1: #  and cur_mode != PACK
            ...
            elif cur_mode == PACK and (self.total_frame_ctr == 1 or self.replay_frame_ctr % PACK_EVAL_FRAMES == 0):
