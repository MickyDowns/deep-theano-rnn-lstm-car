...
class GameState:
    ...
    def create_dog(self):
        ...
        self.dog_body.position = 50, height - 100
        self.dog_shape = pymunk.Circle(self.dog_body, 30)
        self.dog_shape.color = THECOLORS["orange"]
    ...
    def frame_step(self, action):
        ...
        # Move obstacles - they're 100x more stable than self
